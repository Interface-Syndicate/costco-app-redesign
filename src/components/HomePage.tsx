...
import { TwoLayerCarousel } from './TwoLayerCarousel';
...
export function HomePage({ dealProducts, onAddToCart, recentlyViewed, onServiceClick, onShowAllDeals, onShowAllRecommendations, onShowAllServices, onProductClick, isGuest = false }: HomePageProps) {
  const services = [
  ...
  return (
    <div className="pb-4">
      ...
      {/* Two Layer Carousel - You May Also Like */}
      <TwoLayerCarousel 
        onAddToCart={onAddToCart}
        onProductClick={onProductClick}
        isGuest={isGuest}
        onShowAll={onShowAllRecommendations}
      />
      ...
      <div className="mb-6">
        <div className="px-4 flex items-center justify-between mb-3">
          ...
          <button className="text-[#6A89A7] text-sm hover:text-[#88BDF2] transition-colors" onClick={onShowAllServices}>
            See All &gt;
          </button>
        </div>
      ...
      {recentlyViewed && recentlyViewed.length > 0 && (
        <div className="mb-6">
          <div className="px-4 flex items-center justify-between mb-3">
            ...
            <button className="text-[#6A89A7] text-sm hover:text-[#88BDF2] transition-colors" onClick={onShowAllRecommendations}>
              See All &gt;
            </button>
          </div>
          <div className="overflow-x-auto scrollbar-hide">
